export const en = {
  ...
  settings: {
    ...
    localSection: 'Local storage',
    clearCache: 'Clear local cache',
    clearCacheDesc: 'Delete downloaded files, local playlists and play history',
    clearCacheTitle: 'Clear local cache?',
    clearCacheMessage:
      'This will remove downloaded tracks and reset the local music database on this device. Your account and cloud backup will stay untouched.',
